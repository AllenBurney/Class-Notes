...
BEGIN
	...
	INSERT INTO Employee519(empid,ename,basic_salary,gross_salary,pf,tax,net_salary) 
	VALUES(v_empid,v_ename,v_basic,v_gross,v_pf,v_tax,v_net);
	COMMIT;
	...
	UPDATE Employee519
	set total_net_salary=v_total_net;
